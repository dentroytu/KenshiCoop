# CoopHarness.psm1 - shared launch/environment helpers for the TokelaCoop test
...
$script:CoopDiagEnvKeys = @(
    ...
    'TOKELACOOP_SPEED_SYNC'
    'TOKELACOOP_MONEY_SYNC'
    'TOKELACOOP_SPAWN_SYNC'
    'TOKELACOOP_RECRUIT_SYNC'
    'TOKELACOOP_FACTION_SYNC'
    'TOKELACOOP_TIME_SYNC'
    'TOKELACOOP_DOOR_SYNC'
    'TOKELACOOP_BUILD_SYNC'
    'TOKELACOOP_BDOOR_SYNC'
    'TOKELACOOP_HUNGER_SYNC'
    'TOKELACOOP_SAVE_SYNC'
    'TOKELACOOP_LOAD_SYNC'
    'TOKELACOOP_PROD_SYNC'
    'TOKELACOOP_RESEARCH_SYNC'
    'TOKELACOOP_DEED_SYNC'
    'TOKELACOOP_STORE_SYNC'
    'TOKELACOOP_SQUAD_SYNC'
    'TOKELACOOP_LATEJOIN_SYNC'
    # --- log-only diagnostic traces (read outside Config; never gate behavior) ---
    'TOKELACOOP_INV_DUMP'
    'TOKELACOOP_DEBUG_SPEED'
    'TOKELACOOP_DEBUG_SHACKLE'
    ...
    # renders the drive tiers unless TOKELACOOP_CELL_AUTH=1 also puts it through
    # enforceHostAuthority, so a scenario wanting both sides labelled must set
    # both keys.
    'TOKELACOOP_DEBUG_MARKERS'
    ...
    # TOKELACOOP_CELL_AUTH=1 - with authority off the host already owns the map.
    'TOKELACOOP_CELL_COLLAPSE'
    ...
    'TOKELACOOP_DEBUG_CENSUS'
    'TOKELACOOP_JAIL_PROBE'
    'TOKELACOOP_TASK_SPIKE'
    'TOKELACOOP_JAIL_OBSERVE'
    ...
    'TOKELACOOP_WD_REFUSE_REHOME'
    'TOKELACOOP_WD_REFUSE_REHOME_ALL'
...
function Set-CoopDiagEnv {
    ...
    Set-Item -Path "env:TOKELACOOP_CELL_AUTH" -Value "0"
